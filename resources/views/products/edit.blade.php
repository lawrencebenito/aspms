...
@section('page_header')
  <i class="ion ion-tshirt"></i> <span>Edit Product</span>
@endsection

@section('content')
<!-- form start -->
<form class="form" method="POST" action="{{ URL('/products')}}/{{$product->id}}" onsubmit="return validate(this);">
@CSRF
  ...
  <div class="col-lg-12">
    <div class="box box-success box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">Product Header - Editing product: {{$product->style_number}}</h3>
        <input id="product" type="hidden" class="form-control" value="{{$product}}">
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="col-sm-12 form-group">
              ...
              <input type="text" class="form-control" placeholder="Any description for this product" name="description" autocomplete="off" value="{{$product->description}}">
            </div>
          </div>
          <!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" style="white-space:nowrap; width:130%; max-width:130%;">
                ...
                <tbody id="fabric_consumption">
                  <input id="fabrics" type="hidden" class="form-control" value="{{$fabrics}}">
                </tbody>
              </table>
            </div>
          </div>
