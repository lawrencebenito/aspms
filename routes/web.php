...
Route::get('SalesReport/export','ReportsController@export_sales_report');
/// end ignore
...
Route::get('SalesOrders/invoice','OrdersController@invoice');
Route::get('SalesOrders/invoice/save','OrdersController@save_invoice');
